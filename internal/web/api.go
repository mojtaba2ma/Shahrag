...
func (s *Server) routes() {
	...
	s.mux.HandleFunc("POST /api/services/{name}/toggle", s.requireAuth(s.handleToggleService))
	s.mux.HandleFunc("POST /api/services/gate-secret", s.requireAuth(s.handleGenerateGateSecret))
	...
	s.mux.HandleFunc("POST /api/reality/services/{name}/toggle", s.requireAuth(s.handleToggleRealityService))
	...
	s.mux.HandleFunc("GET /api/settings/proxies", s.requireAuth(s.handleGetProxies))
	s.mux.HandleFunc("PUT /api/settings/proxies", s.requireAuth(s.handleSetProxies))
	...
	s.mux.HandleFunc("GET /api/autoban/offenders", s.requireAuth(s.handleListOffenders))
	s.mux.HandleFunc("DELETE /api/autoban/offenders/{ip}", s.requireAuth(s.handleForgiveOffender))
	s.mux.HandleFunc("DELETE /api/autoban/offenders", s.requireAuth(s.handleForgiveAll))
	...
	s.mux.HandleFunc("PUT /api/services/{name}/raw", s.requireAuth(s.handleSaveServiceRaw))
	s.mux.HandleFunc("GET /api/reality/services/{name}/raw", s.requireAuth(s.handleGetSNIRaw))
	s.mux.HandleFunc("PUT /api/reality/services/{name}/raw", s.requireAuth(s.handleSaveSNIRaw))
	...
	s.mux.HandleFunc("GET /api/stats/bans", s.requireAuth(s.handleStatsBans))
